...
func shoot():
	...
	if pool_manager != null and pool_manager.has_method("spawn_tank_bullet"):
		var pooled_bullet: Node = pool_manager.call("spawn_tank_bullet", shootingpoint.global_position, direction, direction.angle())
